...
export const SuccessAlert = ({ label }) => {
    return (
...
export const WarningAlert = ({ label }) => {
    return (
        <div className="bg-yellow-200 px-6 py-4 mx-2 my-4 rounded-md text-lg flex items-center mx-auto w-3/4 xl:w-2/4">
...
export const InfoAlert = ({ label }) => {
    return (
        <div className="bg-blue-200 px-6 py-4 mx-2 my-4 rounded-md text-lg flex items-center mx-auto w-3/4 xl:w-2/4">
